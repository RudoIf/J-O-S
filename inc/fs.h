...
//authority
#define	F_EXECUTAB	0X01
#define	F_WRITABLE	0X02
...
struct File {
	...
	uint8_t f_pad[256 - MAXNAMELEN - 8 - 4*NDIRECT - 4 - 11];
...
#define FTYPE_DEV	2	// Device
#define FTYPE_SOC	3	// Socket
